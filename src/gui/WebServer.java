...
public class WebServer extends JFrame implements ActionListener {
	...
	private void initializeRunServerPanel() {
		// Run server widgets
	...
	private void addListeners() {
		...
		this.butStartServer.addActionListener(this);
		
		// Add action for stop button
		this.butStopServer.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(this.butSelect)){
			getDirectory();
		} else if (e.getSource().equals(this.butStartServer)){
			startServer();
		} else if (e.getSource().equals(this.butStopServer)){
			stopServer();
		}
	}
